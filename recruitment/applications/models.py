...
class Application(models.Model):
    ...
    applicant_gender = models.CharField(max_length = 6,null = True)
    ...
    applicant_major = models.CharField(max_length = 100,null = True)
    applicant_school = models.CharField(max_length = 100,null = True)
    applicant_graduation_date = models.DateField(null = True)
    applicant_email = models.EmailField(null = True)
    applicant_photo = models.ImageField(null = True,upload_to ='applications/avatars')
